		...
		<table width="966" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="237" valign="top">
					...
					<table width="237" height="450" border="0" cellspacing="0" cellpadding="26" bgcolor="#4A748A">
						<tr>
							<td>
							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											<!-- content start -->
											<?php echo $page_content; ?><br/><br/><hr/><br/>
											<form action="" method="post" class="form-signin">
											<input type='hidden' name='contact_us' />
											<?php if($logged_in==false){ ?>
											<strong>Your Name</strong><br/>
											<input type="text" name="member_query_name" class="form-control" /><br/><br/>
											<strong>Your Email (So that we can get back to you)</strong><br/>
											<input type="text" name="member_query_email" class="form-control" /><br/><br/>
											<?php } ?>
											<strong>Your Query</strong><br/>
											<textarea name='member_query_msg' style="width:360px;height:100px" placeholder="TYPE YOUR MESSAGE HERE..." class="form-control"></textarea><br/><br/>
