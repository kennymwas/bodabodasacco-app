									...
									<tr>
										<td>
											...
											<?php
												...
												echo "<tr class='bg2'><td><strong>Loan Payment Amount</strong></td>";
												echo "<td><strong>Payment Date</strong></td>";
												echo "<td><strong>Loan Balance After Payment</strong></tr>";
												...
												echo "[ <a href='".$base_url."loan/'>back to loan listing</a> ]<br/>";
