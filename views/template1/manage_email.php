								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											?>
												No Email Data added. Click <a href='<?php echo $base_url ?>email/add'>here</a> to add one
											<?php
											}else{
												echo "<h2>Email Listing</h2><br/>";
												...
												foreach($email_list as $email){
													...
													if($email['public']==1){
														echo "<td>[ <a href='".$base_url."email/hide/".$email['email_id']."'><span style='color:red'>Public</span></a> ]</td>";
													}else{
														echo "<td>[ <a href='".$base_url."email/show/".$email['email_id']."'><span style='color:green'>Hidden</a></span> ]</td>";
													}
													echo "<td>[ <a href='".$base_url."email/edit/".$email['email_id']."'>edit</a> ] | ";
													echo "[ <a href='".$base_url."email/delete/".$email['email_id']."'><span style='color:red'>delete</span></a> ]</td>";
													echo "</tr>";
												}
												echo "</table><br/><br/>";
												echo "Email Count: ".$email_list_count."<br/><br/>";
												echo "[ <a href='".$base_url."email/add'>add email data</a> ]<br/>";
