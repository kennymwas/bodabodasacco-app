									...
									<tr>
										<td>
											...
											<form class="form-signin" action="" method="post" >
												<label for="email">Member Email:</label><br/>
												<input type='text' class="form-control" name='user_email'  placeholder="EMAIL" required /><br/><br/>
												<label for="password">Member Password:</label><br/>
												<input type='password' name='user_pass' class="form-control" placeholder="********" required /><br/><br/>
												<input type='submit' value='Login' class="btn btn-primary" /><br/><br/>
												Not registered? Sign up <a href='<?php echo $base_url ?>member/register'>here</a><br>
												Forgot password?<a href='<?php echo $base_url ?>member/forgotpassword'>click here</a>
											</form>
