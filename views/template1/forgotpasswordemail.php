...
try {
    ...
    $mail->AddEmbeddedImage('images/logo.png', 'logoimg', 'images/logo.png');
    ...
    $mail->Body  ='Hi, ' . $name .
     '<html>
        ...
        <body>
        <p>Below is your password please follow the  link below to reset your password. </p>
        <p>Please follow this link to reset your password <a href="http://localhost/sacco_system/index.php/member/resetPassword"><u>link</u></a></p>
         <p>Your email to login is :  '.$email.'</p>
        </body> 
        </html>'.
        ' Your password to login is :  ' . $member_token ;
