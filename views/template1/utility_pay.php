							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											<!-- content start -->
											TRANSACTION CHARGE: <?php echo $payment_charge; ?> <br/><br/>
											RECEPIENT COMPANY: <?php echo $utility_name; ?> <br/><br/>
											<form action="" method="post">
											<input type='hidden' name='pay_utility' value='<?php echo $utility_id; ?>' />
											Amount TO PAY:<br/>
											<input type="text" name="pay_amount" /><br/><br/>
											<input type="submit" value="Pay" /> | 
											<input type="button" onclick="window.location='<?php echo $base_url; ?>utility'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
