						...
						<td width="40"><img src="<?php echo $template_path ?>images/spacer.gif" width="80" height="1" border="0"></td>
							<td width="100%">
								<table width="120%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="200" align="left"><h1><?php if(isset($_page_title)) echo $_page_title ?></h1></td>
									</tr>
									<tr>
										<td width='20px'>
									...
									<tr>
										...
										?>
											<form action="" method="post">
												<input type='hidden' name='value_transfer' />
												Recipient :<br/>
												<input type='text' name='recipient_email' /><br/><br/>
												Value Type:<br/>
												<select name='value_type'>
													<option value='fund' selected='selected' >Funds</option>
										...
										?>
											...
											<br/><br/>
											<strong>TRANSFER CHARGE TO SENDER: </strong><br/>
											<?php echo $sender_trans_charge ; ?>
											<br/><br/>
											<strong>TRANSFER CHARGE TO RECIPIENT: </strong><br/>
											<?php echo $recipient_trans_charge ; ?>
											<br/><br/><br/>
											To confirm and effect this transaction:
											<form action='' method='post'>
												<input type='hidden' name='make_value_transfer' />
												<input type='submit' value='Click here to MAKE transaction' />
											</form><br/><br/>
											To cancel this transaction:
											<form action='' method='post'>
												<input type='hidden' name='cancel_value_transfer' />
												<input type='submit' value='Click here to CANCEL transaction' />
											</form><br/><br/>
										<?php 
										}else if($transfer_step==3){
										?>
											<h2><?php echo $transfer_info; ?></h2><br/>
											[ <a href="<?php echo $base_url; ?>value_transfer">...new value transfer ? </a> ]
										<?php 
										...
										<td>
										<p >
										<strong><img src="<?php echo $template_path ?>images/spacer.gif" width="200" height="0" border="0"> 
										Your Current Account Status</strong>:<br/> <br/>
										<img src="<?php echo $template_path ?>images/spacer.gif" width="200" height="0" border="0">
										...
										Fund Balance:<br/>
										<img src="<?php echo $template_path ?>images/spacer.gif" width="200" height="0" border="0">
										<?php echo $site_currency.$fund_balance ; ?>
										<br><br>
										<img src="<?php echo $template_path ?>images/spacer.gif" width="200" height="0" border="0">
										Share Balance:<br/>
										<img src="<?php echo $template_path ?>images/spacer.gif" width="200" height="0" border="0">
