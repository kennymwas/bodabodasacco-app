									...
									<tr>
										<td>
											...
											<form action="" method="post">
												<strong>Loan Balance : <?php echo $site_currency.$loan_balance; ?></strong><br/><br/>
												<input type='hidden' name='add_loan_payment' value="<?php echo $loan_id; ?>" />
												Payment Amount<br/>
												<input type="text" name="loan_payment_amount" /><br/><br/>
