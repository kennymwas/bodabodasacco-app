									...
									<tr>
										<td>
											...
											if($utility_count == 0){
												...
												echo "<td><strong>Account Detail</strong></td>";
												...
												foreach($utility_list as $utility){
													...
													echo "<td>".$utility['utility_member_account']."</td>";
													...
													if($utility['utility_available']){
														echo "<td>[ <a href='".$base_url."utility/pay/".$utility['utility_id']."'>make payments</a> ]<br/>";
														echo "[ <a href='".$base_url."utility/remove/".$utility['utility_id']."'>delete utility account</a> ]<br/>";
														echo "[ <a href='".$base_url."utility/payments/".$utility['utility_id']."'>list payments</a> ]</td>";
													}else{
														echo "<td>- payments disabled -<br/>";
														echo "[ <a href='".$base_url."utility/remove/".$utility['utility_id']."'>delete utility account</a> ]<br/>";
														echo "[ <a href='".$base_url."utility/payments/".$utility['utility_id']."'>list payments</a> ]";
													}
													echo "</tr>";
												}
												echo "</table><br/>";
												echo "<br/>[ <a href='".$base_url."utility/add'>add utility</a> ]";
											}
											?>
											<!-- content end -->
										</td>
