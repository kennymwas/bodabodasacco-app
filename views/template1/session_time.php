								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											Inactivity Time to Effect Automatic log-off<br/>
											<input type="text" name="session_time" /> Minutes<br/><br/>
											<input type="submit" value="Update Time" /> | 
											<input type="button" onclick="window.location='<?php echo $base_url; ?>member/info'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
