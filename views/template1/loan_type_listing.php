								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											?>
												No Loan-Types have been defined yet...
											<?php
											}else{
												...
												foreach($loan_type_list as $loan_type){
													...
													echo "<td>".$loan_type['loan_type_account_age_threshold']." months</td>";
													echo "<td>".$loan_type['loan_type_interest']." %</td>";
													echo "<td>[<a href='".$base_url."loan/add/".$loan_type['loan_type_id']."'>APPLY</a>]</td> ";
													echo "</tr>";
												}
												echo "</table><br/><br/>";
