				...
				<td width="237" valign="top">
					...
					<table width="237" border="0" cellspacing="0" cellpadding="26" bgcolor="#4A748A">
						<tr>
							<td>
								<span class="style4">
								Welcome to BodaBoda Sacco Application
								</span>
							</td>
						</tr>
					</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<h1>MEMBER DATA ERROR</h1><br><br>
											This system encountered errors or inconsistencies while handling your member-data.<br/><br/>
											This may be caused by missing data about some aspects of your membership.<br/><br/>
											An error log for this has been created and the site admins automatically notified about this,<br/>
											And you are advised to follow this up with customer support.<br/><br/>
											We apologize for any inconvinience.<br/><br/>
											<?php if(isset($error_msg)) echo 'REPORTED ERROR: '.$error_msg; ?>
