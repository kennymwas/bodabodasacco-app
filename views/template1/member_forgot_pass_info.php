...
<?php include ('forgotpasswordemail.php');?>
<?php include ('forgot_pass_sms.php');?>
<body>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<h1><font color="green">PASSWORD LINK SENT</font></h1><br><br>
											<h2>Thank you <strong><?php echo $name ?></strong> your password reset link has been sent to your email.</h2>
