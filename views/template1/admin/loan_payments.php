								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											<!-- content start -->
											<?php
											//print_r($loan_payment_list);
											if($loan_payment_count == 0){
											?>
												No Payments have been made
											<?php
											}else{
												echo "<h2>Loan Payment Listing</h2><br/>";
												echo "<table width='500px' class='dotted'>";
												echo "<tr class='bg2'><td><strong>Member Name</strong></td>";
												echo "<td><strong>Loan Payment Amount</strong></td>";
												echo "<td><strong>Balance After Payment</strong></td>";
												echo "<td><strong>Payment Date</strong></td>";
												foreach($loan_payment_list as $loan){
													echo "<tr >";
													echo "<td>[<a href='".$admin_url."members/view_detail/".$loan['member_id']."'>".$loan['member_name']."</a>]</td>";
													echo "<td>".$site_currency.$loan['loan_payment_amount']."</td>";
													echo "<td>".$site_currency.$loan['loan_balance']."</td>";
													echo "<td>".$loan['loan_payment_date']."</td>";
													echo "</tr>";
												}
												echo "</table><br/><br/>";
												echo "Payments Count: ".$loan_payment_count."<br/><br/>";
												echo "Payment Total: ".$site_currency.$loan_payment_total."<br/><br/>";
											}
											echo "<br/><br/>[ <a href='".$admin_url."loan/'>back to loan listing</a> ]<br/><br/><br/>";
											?>
											<!-- content end -->
										</td>
									</tr>
