									...
									<tr>
										<td><br/><br/>
											...
											<form action='' method="post">
												<input type='hidden' name='page_add' />
												<strong>Page Title</strong><br/>
												<input type='text' name='page_title' /><br/><br/>
												<strong>Page Description</strong><br/>
												<textarea name='page_desc' style='width:260px;height:90px' /></textarea><br/><br/>
												<strong>Page Content</strong><br/>
												<textarea style='width:100%;height:500px' name='page_content' /></textarea><br/><br/>
