							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											<!-- content start -->
											[<a href='<?php echo $admin_url.'list_utility/edit/'.$utility_id ?>'>Edit this</a>]<br/>
											<form method='post' action='' >
												<strong>Utility Name</strong><br/>
												<?php echo $utility_name; ?><br/><br/>
												<strong>Utility Website</strong><br/>
												<?php echo $utility_website; ?><br/><br/>
												<strong>Utility Email</strong><br/>
												<?php echo $utility_email; ?><br/><br/>
												<strong>Utility Phone</strong><br/>
												<?php echo $utility_phone; ?><br/><br/>
												<strong>Utility Postal Address</strong><br/>
												<?php echo $utility_postal; ?><br/><br/>
												<strong>Utility Physical Address</strong><br/>
												<?php echo $utility_address; ?><br/><br/>
