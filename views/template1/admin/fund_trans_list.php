										...
										<td>
											...
											<?php
												if(isset($no_page_info)){
													...
													echo '<td><strong>Transaction Amount</strong></td>';
													foreach($trans_list as $row_data){
														...
														echo '<td>'.$row_data['fund_transaction_id'].'</td>';
														echo '<td>'.$row_data['cred_name'].'</td>';
														echo '<td>'.$row_data['deb_name'].'</td>';
														echo '<td>'.$row_data['fund_transaction_date'].'</td>';
														echo '<td>'.$row_data['fund_transaction_amount'].'</td>';
														echo "</tr>";
													}
													echo '</table><br/><br/>';
													if($pageNum==1){
													...
													echo 'Transaction Count : <strong>'.$trans_count.'</strong><br/><br/><br/>';
												}
											?>
											<!-- content end -->
										</td>
