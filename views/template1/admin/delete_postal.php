								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='delete_postal' value = "<?php echo $postal_id; ?>" />
											<strong>Postal Front Name</strong><br/>
											<?php echo $front_name; ?><br/><br/>
											<strong>Postal Detail</strong><br/>
											<?php echo $detail; ?><br/><br/>
											<strong>Postal Code</strong><br/>
											<?php echo $code; ?><br/><br/>
											<strong>Postal City</strong><br/>
											<?php echo $city; ?><br/><br/>
											...
											<strong>Visibility</strong><br/>
												...
												?>
											<br/><br/>
											Are you sure you want to delete this postal data?
											<br/>
											<input type="submit" value="YES" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>postal'" value="NO" />
											</form>
											<!-- content end -->
										</td>
									</tr>
