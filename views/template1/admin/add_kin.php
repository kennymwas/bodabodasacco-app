								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='add_kin' />
											Kin Name<br/>
											<input type="text" name="name" /><br/><br/>
											Kin Relation<br/>
											<input type="text" name="relation" /><br/><br/>
											Kin Phone<br/>
											<input type="text" name="phone" /><br/><br/>
											Kin Address<br/>
											<textarea name="address" style="width:250px;height:75px"></textarea>
											<br/><br/>
											<input type="submit" value="Add Kin" /> | 
