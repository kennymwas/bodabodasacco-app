											...
											<?php
												if(isset($no_page_info)){
													...
													foreach($news_list as $row_data){
														...
														echo '<td>[ <a href=\''.$admin_url.'news/delete/'.$row_data['news_url_title'].'\'>delete entry</a> ]<br/>
																[ <a href=\''.$admin_url.'news/edit/'.$row_data['news_url_title'].'\'>edit entry</a> ] |  
																[ <a href=\''.$base_url.'news/'.$row_data['news_url_title'].'\'>view news entry</a> ] </td>';
														echo "</tr>";
													}
													echo '</table><br/><br/>';
													if($news_number==1){
														...
														echo'[  <a href=\''.$admin_url.'news/list/page/1\'> f i r s t </a> ] .:|:. ';
													}
													if($news_number==1){
														echo" p r e v i o u s  .:|:. ";
													}else{
														echo'[ <a href=\''.$admin_url.'news/list/page/'.($news_number-1).'\'> p r e v i o u s </a> ] .:|:. ';
													}
													if($news_number==$news_count){
														echo" n e x t  .:|:. ";
													}else{
														echo'[ <a href=\''.$admin_url.'news/list/page/'.($news_number+1).'\'> n e x t </a> ] .:|:. ';
													}
													if($news_number==$news_count){
														echo" l a s t <br><br>";
													}else{
														echo'[ <a href=\''.$admin_url.'news/list/page/'.$news_count.'\'> l a s t </a> ]<br><br>';
													}
