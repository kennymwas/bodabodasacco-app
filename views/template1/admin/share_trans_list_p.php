										...
										<td>
											...
											<?php
												if(isset($no_page_info)){
													...
													echo '<td><strong>Transaction ID</strong></td>';
													...
													foreach($trans_list as $row_data){
														...
														echo "<td>[<a href='".$admin_url."share_trans/approve/".$row_data['share_transaction_id']."'>approve</a>] | [<a href='".$admin_url."share_trans/cancel/".$row_data['share_transaction_id']."'>cancel</a>]</td>";
														echo "</tr>";
													}
													echo '</table><br/><br/>';
													if($pageNum==1){
														...
														echo'[  <a href=\''.$admin_url.'share_trans/list_p/page/1\'> f i r s t </a> ] .:|:. ';
													}
													if($pageNum==1){
														echo" p r e v i o u s  .:|:. ";
													}else{
														echo'[ <a href=\''.$admin_url.'share_trans/list_p/page/'.($pageNum-1).'\'> p r e v i o u s </a> ] .:|:. ';
													}
													if($pageNum==$site_page_count){
														echo" n e x t  .:|:. ";
													}else{
														echo'[ <a href=\''.$admin_url.'share_trans/list_p/page/'.($pageNum+1).'\'> n e x t </a> ] .:|:. ';
													}
													if($pageNum==$site_page_count){
														echo" l a s t <br><br>";
													}else{
														echo'[ <a href=\''.$admin_url.'share_trans/list_p/page/'.$site_page_count.'\'> l a s t </a> ]<br><br>';
													}
