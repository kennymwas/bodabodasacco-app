									...
									<tr>
										<td>
											...
											if($data_list_count == 0){
												...
												echo "<h2>Site-Configs</h2><br/>";
												echo "<table width='100%' class='dotted'>";
												echo "<tr class='bg2'><td><strong>Config Name</strong></td>";
												echo "<td><strong>Config Value</strong></td>";				
												echo "<td><strong>Actions</strong></td></tr>";
												foreach($data_list as $dt){
													echo "<tr >";
													echo "<td>".$dt['config_name']."</td>";
													echo "<td>".$dt['config_value']."</td>";
													echo "<td>[ <a href='".$admin_url."site_config/edit/".$dt['config_name']."'>Edit Value</a> ]</td>";
													echo "</tr>";
												}
												echo "</table><br/><br/>";
											}
