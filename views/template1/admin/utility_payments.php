									...
									<tr>
										<td>
											...
											<?php
												...
												echo "<td><strong>Payment Amount</strong></td>";
												echo "<td><strong>Charge</strong></td>";
												echo "<td><strong>Payment Date</strong></td>";
												foreach($utility_payment_list as $utp){
													echo "<tr >";
													echo "<td>[<a href='".$admin_url."members/view_detail/".$utp['member_id']."'>".$utp['member_name']."</a>]</td>";
													echo "<td>".$utp['utility_member_account']."</td>";
											...
											echo "<br/><br/>[ <a href='".$admin_url."list_utility/'>Back to utility listing</a> ]<br/><br/><br/>";
											?>
											<!-- content end -->
										</td>
									</tr>
