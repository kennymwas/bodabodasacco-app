								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='edit_physicalAddress' value = "<?php echo $physicalAddress_id; ?>" />
											Physical Address Front Name<br/>
											<input type="text" name="front_name" value = "<?php echo $front_name; ?>" /><br/><br/>
											Physical Address Detail<br/>
											<textarea name="detail" style="width:250px;height:75px"><?php echo $detail; ?></textarea><br/><br/>
											Physical Address City<br/>
											...
											<br/><br/>
											<input type="submit" value="Update Physical Address Data" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>physicalAddress'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
