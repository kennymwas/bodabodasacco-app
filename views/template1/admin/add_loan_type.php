								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='add_loan_type' value='' />
											<strong>Loan Type Name</strong><br/>
											<input type='text' name='loan_type_name' value='' /><br/><br/>
											<strong>Minimum Repayment Period (in months)</strong><br/>
											<input type='text' name='loan_type_min_months' value='' /><br/><br/>
											<strong>Maximum Repayment Period (in months)</strong><br/>
											<input type='text' name='loan_type_max_months' value='' /><br/><br/>
											<strong>Minimum Loan Amount</strong><br/>
											<input type='text' name='loan_type_min_amount' value='' /><br/><br/>
											<strong>Maximum Loan Amount</strong><br/>
											<input type='text' name='loan_type_max_amount' value='' /><br/><br/>
											<strong>Share Balance Threshold</strong><br/>
											<input type='text' name='loan_type_share_threshold' value='' /><br/><br/>
											<strong>Fund Balance Threshold</strong><br/>
											<input type='text' name='loan_type_fund_threshold' value='' /><br/><br/>
											<strong>Account Age Threshold (in months)</strong><br/>
											<input type='text' name='loan_type_account_age_threshold' value='' /><br/><br/>
											<strong>Loan Interest</strong><br/>
											<input type='text' name='loan_type_interest' value='' /><br/><br/>
