								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='edit_kin' value = "<?php echo $kin_id; ?>" />
											Kin Name<br/>
											...
											Kin Address<br/>
											<textarea name="address" style="width:250px;height:75px"><?php echo $address; ?></textarea>
											<br/><br/>
											<input type="submit" value="Update Ekin Data" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>kin'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
