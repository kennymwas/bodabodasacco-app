								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='edit_email' value = "<?php echo $email_id; ?>" />
											Email Front Name<br/>
											...
											<br/><br/>
											<input type="submit" value="Update Eemail Data" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>email'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
