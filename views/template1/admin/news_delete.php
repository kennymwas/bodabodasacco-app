									...
									<tr>
										<td>
											...
											<form action='' method="post">
												<input type='hidden' name='news_delete' />
												<strong>News Title</strong><br/>
												<?php echo $news_title ?><br/><br/>
												<strong>News Description</strong><br/>
												<?php echo $news_desc ?><br/><br/>
												<strong>News Date</strong><br/>
												<?php echo $news_date; ?>
												<strong>News Content</strong><br/>
												<?php echo $news_content ?><br/><br/>
												Are you sure you want ot delete this?<br/><br/>
