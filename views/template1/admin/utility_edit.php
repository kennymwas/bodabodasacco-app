									...
									<tr>
										<td>
											...
											<form method='post' action='' >
												<input type='hidden' name='utility_edit' value='<?php echo $utility_id; ?>' />
												<strong>Utility Name</strong><br/>
												<input type='text' name='utility_name' value='<?php echo $utility_name; ?>' /><br/><br/>
												<strong>Utility Website</strong><br/>
												<input type='text' name='utility_website' value='<?php echo $utility_website; ?>' /><br/><br/>
												<strong>Utility Email</strong><br/>
												<input type='text' name='utility_email' value='<?php echo $utility_email; ?>' /><br/><br/>
												<strong>Utility Phone</strong><br/>
												<input type='text' name='utility_phone' value='<?php echo $utility_phone; ?>' /><br/><br/>
												<strong>Utility Postal Address</strong><br/>
												<textarea name='utility_postal'><?php echo $utility_postal; ?> </textarea><br/><br/>
												<strong>Utility Physical Address</strong><br/>
												<textarea name='utility_address'><?php echo $utility_address; ?></textarea><br/><br/>
												<input type='submit' value='Update Utility' /> 
