								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='edit_postal' value = "<?php echo $postal_id; ?>" />
											Postal Front Name<br/>
											...
											<br/><br/>
											<input type="submit" value="Update postal Data" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>postal'" value="Cancel" />
											</form>
											<!-- content end -->
										</td>
									</tr>
