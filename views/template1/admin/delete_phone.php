								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td>
											...
											<input type='hidden' name='delete_phone' value = "<?php echo $phone_id; ?>" />
											<strong>Phone Front Name</strong><br/>
											<?php echo $front_name; ?><br/><br/>
											<strong>Phone Detail</strong><br/>
											...
											<strong>Visibility</strong><br/>
												...
												?>
											<br/><br/>
											Are you sure you want to delete this phone data?
											<br/>
											<input type="submit" value="YES" /> | 
											<input type="button" onclick="window.location='<?php echo $admin_url; ?>phone'" value="NO" />
											</form>
											<!-- content end -->
										</td>
									</tr>
