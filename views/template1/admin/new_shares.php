									...
									<tr>
										<td>
											...
											?>
												...
												<strong>Value per Share [<?php echo $site_currency ?>]</strong><br/>
												<input type="text" name="share_value" value="<?php echo $share_value; ?>" /><br/><br/>
												<strong>Number of shares Floated </strong><br/>
												<input type="text" name="new_share_balance" value="<?php echo $new_share_balance; ?>" /><br/><br/>
												<input type="submit" value="Update" /><br/><br/>
												<input type="button" onclick="window.location='<?php echo $admin_url; ?>share_trans/new_shares'" value="Cancel" />
												</form>
											<?php
											}else{
											?>
											[<a href='<?php echo $admin_url; ?>share_trans/new_shares/edit'>Change values</a>]<br/><br/>
											<strong>Value per Share</strong><br/>
											<?php echo $site_currency.$share_value; ?><br/><br/>
											<strong>Number of shares Floated</strong><br/>
											<?php echo $new_share_balance; } ?>
											<!-- content end -->
										</td>
									</tr>
								</table>
